...
class SAN(nn.Module):
    ...
    def prepare_targets(self, targets, images):
        ...
        for targets_per_image in targets:
            ...
            image_size_xyxy = torch.as_tensor([w, h, w, h], device=self.device)
            gt_classes = targets_per_image.gt_classes
            # print("gt_classes 🔥🔥🔥", gt_classes.dtype)
            gt_boxes = targets_per_image.gt_boxes.tensor / image_size_xyxy
            gt_boxes = box_xyxy_to_cxcywh(gt_boxes)
            # print("gt_boxes 😭😭😭", gt_boxes.dtype)
            # pad gt
            gt_masks = targets_per_image.gt_masks
            # print("gt_masks 🔥🔥🔥", gt_masks.polygons)
            gt_masks = BitMasks.from_polygon_masks(gt_masks.polygons, h, w)
            # print("gt_masks 😭😭😭", gt_masks)
            # transfer gt_masks to tensor to pad the gt_masks
            gt_masks_tensor = gt_masks.tensor
            # print("gt_masks_tensor.shape 🔥🔥🔥", gt_masks_tensor.shape)
            # print("gt_masks_tensor.dtype 🔥🔥🔥", gt_masks_tensor.dtype)
