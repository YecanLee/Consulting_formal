...
def register_ceiling_dataset():
    ...
    # Add thing_classes to the metadata
    metadata = MetadataCatalog.get("ceiling_easy_train")
    metadata.thing_classes = ["mural", "brief", "mural", "relief"]
    ...
    metadata = MetadataCatalog.get("ceiling_easy_val")
    metadata.thing_classes = ["mural", "brief", "mural", "relief"]
    metadata.ignore_label = 255
    metadata.evaluator_type = "coco"  # Add evaluator type for instance segmentation
