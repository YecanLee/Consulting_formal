...
with read_base():
    ...
    from .._base_.datasets.ceiling_painting import *
    from .._base_.schedules.schedule_12e import *

# Import ceiling class IDs
from ext.class_names.ceiling_ids import CEILING_BASE_IDS, CEILING_NOVEL_IDS
...
model = dict(
    ...
    mask_decoder=dict(
        ...
        fix=False,
        ov_classifier_name='RN50x16_CeilingPaintingSegmentationDataset',
        roi_extractor=dict(
