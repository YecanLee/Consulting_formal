...
class MultiScaleMaskedTransformerDecoder(nn.Module):
    ...
    def forward(self, x, mask_features, all_embs, num_synonyms):
        ...
        outputs_mask, attn_mask, pred_logits = self.forward_prediction_heads(output, mask_features, 
        ...
        out = {
            'pred_logits': predictions_logits[-1],
    ...
    def forward_prediction_heads(self, output, mask_features, attn_mask_target_size, all_embs, num_synonyms):
        ...
        outputs_class = get_classification_logits(class_embed, all_embs, self.logit_scale, num_synonyms)
        ...
        return outputs_mask, attn_mask, outputs_class
