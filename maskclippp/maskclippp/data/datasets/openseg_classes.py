...
def get_coco_categories_with_prompt_eng():
    ...
    coco_id_names = open('./maskclippp/data/datasets/coco_panoptic_with_prompt_eng.txt').read().splitlines()
    coco_idx = 0
...
def get_coco_stuff_categories_with_prompt_eng():
    ...
    coco_id_names = open('./maskclippp/data/datasets/coco_stuff_with_prompt_eng.txt').read().splitlines()
    coco_idx = 0
    for line in coco_id_names:
        idx, name = line.split(':')
        idx = int(idx)
...
def get_ade20k_categories_with_prompt_eng():
    ...
    ade20k_id_names = open('./maskclippp/data/datasets/ade20k_150_with_prompt_eng.txt').read().splitlines()
    ade_idx = 0
...
def get_cityscapes_categories_with_prompt_eng():
    ...
    cityscapes_id_names = open('./maskclippp/data/datasets/cityscapes_with_prompt_eng.txt').read().splitlines()
    cityscapes_idx = 0
...
def get_bdd100k_categories_with_prompt_eng():
    BDD100K_NAMES_ = []
    
    bdd100k_id_names = open('./maskclippp/data/datasets/bdd100k_with_prompt_eng.txt').read().splitlines()
    bdd100k_idx = 0
    for line in bdd100k_id_names:
        idx, name = line.split(':')
        idx = int(idx)
        if name == "invalid_class_id":
            continue
        BDD100K_NAMES_.append(name)
        bdd100k_idx += 1
    return BDD100K_NAMES_
        

def get_ade20k_847_categories_with_prompt_eng():
    ADE20K_847_CATEGORIES_ = copy.deepcopy(ADE20K_847_CATEGORIES)
    ade20k_847_id_names = open('./maskclippp/data/datasets/ade20k_847_with_prompt_eng.txt').read().splitlines()
    ade_idx = 0
...
def get_pascal_21_categories_with_prompt_eng():
    ...
    pascal_21_id_names = open('./maskclippp/data/datasets/pascal_voc_21_with_prompt_eng.txt').read().splitlines()
    pas_idx = 0
...
def get_pascal_ctx_459_categories_with_prompt_eng():
    ...
    pascal_ctx_459_id_names = open('./maskclippp/data/datasets/pascal_ctx_459_with_prompt_eng.txt').read().splitlines()
    pas_idx = 0
...
def get_pascal_ctx_59_categories_with_prompt_eng():
    ...
    pascal_ctx_59_id_names = open('./maskclippp/data/datasets/pascal_ctx_59_with_prompt_eng.txt').read().splitlines()
    pas_idx = 0
...
def get_mapillary_vistas_categories_with_prompt_eng():
    ...
    # all id - 1
    for cat in MAPILLARY_VISTAS_SEM_SEG_CATEGORIES_:
        cat["id"] -= 1
    
    mapillary_vistas_id_names = open('./maskclippp/data/datasets/mapillary_vistas_with_prompt_eng.txt').read().splitlines()
    mapillary_idx = 0
...
def get_lvis_1203_categories_with_prompt_eng():
    ...
    LVIS_CATEGORIES_ = []
    lvis_id_names = open('./maskclippp/data/datasets/lvis_1203_with_prompt_eng.txt').read().splitlines()
    assert len(LVIS_CATEGORIES) == len(lvis_id_names)
    for i, line in enumerate(lvis_id_names):
        idx, name = line.split(':')
        idx = int(idx)
        assert LVIS_CATEGORIES[i]["id"] == idx
        frequency = LVIS_CATEGORIES[i]["frequency"]
        item = {"id": idx, "name": name, "frequency": frequency}
        LVIS_CATEGORIES_.append(item)
