...
class CATSeg(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        # print(outputs.shape, "this is the outputs shape 😭😭😭")
        if self.training:
            # print(batched_inputs[0].keys(), "this is the model input images 😭😭😭")
            # print(f"the ignored value of the model is {self.sem_seg_head.ignore_value}")
            ...
            _onehot = F.one_hot(targets[mask].long(), num_classes=num_classes).float()
