...
class MaskFormer(nn.Module):
    ...
    def from_config(cls, cfg):
        ...
        # replace the class_embed layer
        sem_seg_head.predictor.class_embed = nn.Linear(sem_seg_head.predictor.class_embed.in_features, cfg.MODEL.SEM_SEG_HEAD.NUM_CLASSES + 1)
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            if "instances" in batched_inputs[0]:
                ...
                targets = None
            # print('[debug] 🔥🔥🔥', outputs["pred_logits"].shape)  # (B, N_queries, C)
    ...
    def prepare_targets(self, targets, images):
        ...
        for targets_per_image in targets:
            ...
            gt_masks = BitMasks.from_polygon_masks(gt_masks.polygons, h_pad, w_pad)
