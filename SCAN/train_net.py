...
# OVSeg
from scan import SemanticSegmentorWithTTA, add_ovseg_config
from scan.data import (
...
from scan.evaluation import (
    GeneralizedSemSegEvaluator, SGIoU_SemSegEvaluator
)
from scan.utils.events import WandbWriter, setup_wandb
from scan.utils.post_process_utils import dense_crf_post_process
...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if evaluator_type in ["sem_seg"]:
            if cfg.METRIC == 'Vanilla':
                evaluator = GeneralizedSemSegEvaluator
            elif cfg.METRIC == 'SG-IoU':
                evaluator = SGIoU_SemSegEvaluator
